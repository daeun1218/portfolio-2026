...
export default function ShowcaseSection() {
  return (
    <section className={`section section--dark ${styles.showcase}`} id="showcase" aria-label="Showcase">
      ...
      <ul className={styles.list}>
        {projects.map((p, i) => (
          <li key={i} className={styles.item} data-animate="item" tabIndex={0} role="listitem">
